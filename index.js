...
export default pool;`
  ...
  "drizzle-orm": {
    ...
    snippet: `Unknown — requires verified reference.`
  },
  "typescript": {
    notes: [
...
function codingRulesPrompt() {
  return `
CODING RULES:
- Prefer complete working outputs when the user asks for code
- Use the user's existing language and structure when possible
- Include required imports
- Use environment variables for secrets
- Keep changes minimal when fixing an existing file
- Explanations should be brief unless the user asks for more detail
...
- Focus on correctness and compatibility with the existing project
- Brief notes are allowed if they help avoid obvious mistakes
`;
}
...
Rules:
- Briefly identify the root issue
- Then provide the corrected code or exact fix
